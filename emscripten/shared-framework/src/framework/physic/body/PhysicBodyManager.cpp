...
PhysicBodyManager::BodyWeakRef PhysicBodyManager::createBody(const PhysicBodyDef& def)
{
  return _bodies.acquire(def);
}

PhysicBodyManager::BodyWeakRef PhysicBodyManager::createAndAddBody(const PhysicBodyDef& def)
{
...
void PhysicBodyManager::addBody(PhysicBodyManager::BodyWeakRef ref, short group, short mask)
{
  if (!ref)
    return;
...
const PhysicBodyManager::BodyWeakRef PhysicBodyManager::getBody(unsigned int index) const
{
  return _bodies.get(index);
}

std::size_t PhysicBodyManager::bodySize() const
{
  return _bodies.size();
}

bool PhysicBodyManager::bodyEmpty() const
{
