...
template <typename dynamic_heap_array> class dynamic_heap_array_iterator {
public:
...
template <typename dynamic_heap_array> class dynamic_heap_array_const_iterator {
public:
  using ValueType = typename dynamic_heap_array::ValueType;
...
public:
  dynamic_heap_array_const_iterator(const dynamic_heap_array& container,
                                    int index)
    : _container(container), _index(index) {}
