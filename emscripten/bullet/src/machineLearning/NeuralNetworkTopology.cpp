...
void NeuralNetworkTopology::init(
...
unsigned int NeuralNetworkTopology::getInput() const { return _input; }

unsigned int NeuralNetworkTopology::getOutput() const { return _output; }
...
bool NeuralNetworkTopology::isUsingBias() const { return _useBias; }
