...
void ProfileData::initialise(unsigned int totalCores,
                             unsigned int maxStateHistory) {
...
void ProfileData::clearLatest() { _latestStatesData.clear(); }
...
unsigned int ProfileData::getTotalCores() const { return _totalCores; }
...
const AbstactSimulation::CoreState&
ProfileData::getCoreHistoryData(unsigned int coreIndex,
