...
// #if not defined D_EXPERIMENTAL_CURVED_HUD
  ...
  const glm::mat4 projection = glm::ortho(-hsize.x,hsize.x, -hsize.y,hsize.y, -10.0f, 10.0f);
...
//   glm::mat4 projection = glm::perspective(fovy, aspectRatio, 1.0f, 1000.0f);
