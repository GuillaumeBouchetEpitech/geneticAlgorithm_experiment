...
private:
  struct ExplosionParticle {
    ...
    ExplosionParticle(const glm::vec3& position,
                      const glm::vec3& linearVelocity, const glm::vec3& color,
  ...
  struct TrailParticle : public ExplosionParticle {
    ...
    TrailParticle(const glm::vec3& position, const glm::vec3& linearVelocity,
...
private:
  struct ParticleInstance {
    ...
    ParticleInstance(const glm::vec3& position, float scale,
